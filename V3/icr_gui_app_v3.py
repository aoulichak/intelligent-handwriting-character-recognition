"""
Application GUI de Reconnaissance de Caractères Manuscrits (ICR) - Version 3
Utilise PyQt5 pour l'interface graphique et un modèle CNN Keras pour la prédiction
"""
...
# Supprimer les avertissements Python
warnings.filterwarnings('ignore', category=FutureWarning)
warnings.filterwarnings('ignore', category=DeprecationWarning)

# Configurer TensorFlow pour réduire les messages de log
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'  # 0=all, 1=INFO, 2=WARNING, 3=ERROR
os.environ['TF_ENABLE_ONEDNN_OPTS'] = '0'  # Désactiver oneDNN si problème
...
# Supprimer les messages TensorFlow supplémentaires
...
class ICRMainWindow(QMainWindow):
    """
    Fenêtre principale de l'application ICR - Version 3.
    """
    def __init__(self):
        super().__init__()
        
        self.setWindowTitle("ICR - V3 - Reconnaissance de Caractères Manuscrits")
    ...
    def setup_statusbar(self):
        ...
        # Label pour TensorFlow
        tf_version_label = QLabel(f"TensorFlow: {tf.__version__}")
        tf_version_label.setStyleSheet("color: #7f8c8d; margin-right: 10px;")
        self.statusBar().addPermanentWidget(tf_version_label)
    ...
    def load_model(self, model_path=None):
        ...
        if model_path is None:
            ...
            possible_paths = [
                'ICR_V3_final.keras',
                '../ICR_V3_final.keras',
                os.path.join(os.path.dirname(__file__), 'ICR_V3_final.keras'),
                os.path.join(os.path.dirname(__file__), '..', 'ICR_V3_final.keras'),
            ]
    ...
    def browse_model(self):
        ...
        file_path, _ = QFileDialog.getOpenFileName(
            ...
            "",
            "Fichiers Keras (*.keras *.h5);;Tous les fichiers (*)"
        )
        if file_path:
    ...
    def predict_drawing(self):
        ...
        try:
            ...
            # Préparer l'image pour Keras (ajouter dimension du batch et canal)
            img_tensor = np.expand_dims(img_array, axis=(0, -1))  # Shape: (1, 28, 28, 1)
    ...
    def show_about(self):
        ...
        QMessageBox.about(
            self,
            "À propos de ICR V3",
            """<h2>ICR V3 - Reconnaissance de Caractères Manuscrits</h2>
            <p><b>Version:</b> 3.0</p>
            <p>Application de reconnaissance de caractères manuscrits (A-Z) 
            utilisant un réseau de neurones convolutif (CNN) entraîné avec TensorFlow/Keras.</p>
            ...
            <p><b>Technologies:</b> PyQt5, TensorFlow/Keras, NumPy, PIL</p>
            """
        )
